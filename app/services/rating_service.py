...
# async def create_or_update_rating_service(db: Session, rating: RatingCreate, user_id: int) -> RatingResponse:
#     try:
...
# async def get_ratings_service(db: Session, movie_id: int, skip: int = 0, limit: int = 10, rating_score: RatingScore = None) -> RatingsWithAggregation:
#     try:
